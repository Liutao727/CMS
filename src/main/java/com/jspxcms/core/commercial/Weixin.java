...
public class Weixin {
	public static String massWeixinForm(Integer[] ids, Integer queryNodeId, Integer queryNodeType,
			...
			org.springframework.ui.Model modelMap, TokenHolder tokenHolder, InfoQueryService query)
	...
	public static void massWeixin(String mode, Integer groupId, String towxname, String[] title, String[] author,
			...
			TokenHolder tokenHolder, OperationLogService logService, PathResolver pathResolver) throws IOException {
		// 本功能在商业版中提供
	}
}
