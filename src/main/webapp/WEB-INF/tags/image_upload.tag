...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
      ...
      <div style="margin-top:2px;">
        <input id="${id}Button" type="button" value="<s:message code='choose'/>"/> &nbsp;
        <script type="text/javascript">
        $(function() {
        ...
        <span id="${id}SwfButton"></span><input type="button" value="<s:message code="upload"/>" class="swfbutton"/> &nbsp;
        <input id="${id}SwfCancel" type="button" value="<s:message code="cancel"/>" onclick="${id}SwfUpload.cancelQueue();" disabled="disabled"/>
        <script type="text/javascript">
    ...
    <td align="center" valign="middle">
      <div id="${id}SwfProgress" style="position:absolute;"></div>
