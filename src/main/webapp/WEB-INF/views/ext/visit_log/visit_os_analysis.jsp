...
<div class="content-header">
	<h1><s:message code="visitLog.osAnalysis"/> <small>(<s:message code="totalElements" arguments="${fn:length(list)}"/>)</small></h1>
</div>
<div class="content">
	<div class="box box-primary">
		<div class="box-body table-responsive">
			<form class="form-inline ls-search" action="os_analysis.do" method="get">
			...
			<script type="text/javascript">
			  ...
			  var option = {
				    ...
				    series : [
				        {
				            name: '<s:message code="visitLog.os"/>',
				            type: 'pie',
				            radius : '55%',
				            center: ['50%', '60%'],
				            data:[
