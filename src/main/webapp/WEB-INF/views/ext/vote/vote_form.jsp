		...
		<form class="form-horizontal" id="validForm" action="${oprt=='edit' ? 'update' : 'save'}.do" method="post">
			...
			<div class="box-body">
	            ...
	            <div class="col-sm-8">
					...
					<div class="col-sm-6">
						<div class="form-group">
	            <label class="col-sm-4 control-label"><em class="required">*</em><s:message code="vote.seq"/></label>
	            <div class="col-sm-8">
	            	<f:text name="seq" value="${bean.seq}" default="999" class="form-control {required:true,digits:true}" maxlength="9"/>
	            </div>
	          </div>
	        </div>
	      </div>
