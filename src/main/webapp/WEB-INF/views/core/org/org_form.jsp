...
<div class="content-header">
	<h1><s:message code="org.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></h1>
</div>
<div class="content">
			...
			<div class="box-header with-border">
				<div class="btn-toolbar">
					<div class="btn-group">
						...
						<button class="btn btn-default" type="button" onclick="location.href='create.do?parentId=${parent.id}&${searchstring}';"<c:if test="${oprt=='create'}"> disabled="disabled"</c:if>><s:message code="create"/></button>
						</shiro:hasPermission>
					</div>
					<div class="btn-group">
