...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="message.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="message.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}" style="width:150px;"/></label>
...
<tags:search_params/>
<div class="ls-bc-opt">
	<shiro:hasPermission name="core:message:create">
	...
	<shiro:hasPermission name="core:message:copy">
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr class="ls_table_th">
    ...
    <th class="ls-th-sort"><span class="ls-sort" pagesort="name"><s:message code="message.name"/></span></th>
  </tr>
  </thead>
  <tbody>
