...
<div class="content-header">
	<h1><s:message code="model.management"/> - <s:message code="model.type.user"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></h1>
</div>
<div class="content">
	<div class="box box-primary">
		<form class="form-horizontal" id="validForm" action="${oprt=='edit' ? 'update' : 'save'}.do" method="post">
			...
			<div class="box-body">
	            ...
	            <div class="col-sm-10">
					      <p class="form-control-static"><s:message code="model.type.${queryType}"/><f:hidden name="type" value="user"/></p>
	            </div>
	          </div>
	        </div>
	      </div>
