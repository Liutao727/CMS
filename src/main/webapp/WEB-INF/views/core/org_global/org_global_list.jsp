...
<div class="content-header">
	<h1><s:message code="orgGlobal.management"/> - <s:message code="list"/> <small>(<s:message code="totalElements" arguments="${fn:length(list)}"/>)</small></h1>
</div>
<div class="content">
			...
			<form action="batch_update.do" method="post">
				...
				<div class="btn-toolbar ls-btn-bar">
					<div class="btn-group">
						...
						<button class="btn btn-default" type="button" onclick="location.href='create.do?showDescendants=${showDescendants}&queryParentId=${queryParentId}&${searchstring}';"><s:message code="create"/></button>
						</shiro:hasPermission>
					</div>
					<div class="btn-group">
