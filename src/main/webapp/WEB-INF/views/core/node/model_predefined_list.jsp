			...
			<form id="fieldForm" action="batch_save.do" method="post">
				...
				<table id="pagedTable" class="table table-condensed table-bordered table-hover ls-tb form-inline">
				  ...
				  <tr>
				    ...
				    <td align="center"><input class="form-control input-sm" type="text" name="label" value="<s:message code='node.parent'/>"/></td>
				  ...
				  <tr>
				    ...
				    <td align="center"><input class="form-control input-sm" type="text" name="label" value="<s:message code='node.link'/>"/></td>
				    <td align="center"><f:checkbox name="dblColumn" value="true"/></td>
				  </tr>
				  </c:if>
				  ...
				  <tr>
				    ...
				    <td align="center"><input class="form-control input-sm" type="text" name="label" value="<s:message code='node.newWindow'/>"/></td>
				    <td align="center"><f:checkbox name="dblColumn" value="true"/></td>
				  </tr>
				  </c:if>
				  ...
				  <tr>
				    ...
				    <td align="center"><input class="form-control input-sm" type="text" name="label" value="<s:message code='node.smallImage'/>"/></td>
				    <td align="center"><f:checkbox name="dblColumn" value="false"/></td>
				  </tr>
				  </c:if>
				  ...
				  <tr>
				    ...
				    <td align="center"><input class="form-control input-sm" type="text" name="label" value="<s:message code='node.largeImage'/>"/></td>
				    <td align="center"><f:checkbox name="dblColumn" value="false"/></td>
				  </tr>
				  </c:if>
