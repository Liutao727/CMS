...
<div class="content-header">
    <h1><s:message code="node.management"/> - <s:message code="merge"/></h1>
</div>
<div class="content">
    <div class="box box-primary">
        <form id="validForm" class="form-horizontal" action="merge_submit.do" method="post">
            <tags:search_params/>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        <label class="control-label col-sm-2"><s:message code="node.deleteMergedNode"/></label>
                        <div class="col-sm-10">
                            <label class="checkbox-inline"><f:radio name="deleteMergedNode" value="true" checked="${deleteMergedNode}" default="true"/><s:message code="yes"/></label>
                            <label class="checkbox-inline"><f:radio name="deleteMergedNode" value="false" checked="${deleteMergedNode}"/><s:message code="no"/></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 text-center">
                        <s:message code="node.mergeSrcNode"/>
                    </div>
                    <div class="col-sm-6 text-center">
                        <s:message code="node.destNode"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
