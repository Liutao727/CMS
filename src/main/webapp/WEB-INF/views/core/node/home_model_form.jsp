...
<div class="content-header">
	<h1><s:message code="model.management"/> - <s:message code="model.type.node_home"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></h1>
</div>
<div class="content">
	<div class="box box-primary">
		<form class="form-horizontal" id="validForm" action="${oprt=='edit' ? 'update' : 'save'}.do" method="post">
			...
			<div class="box-body">
	            ...
	            <div class="col-sm-10">
					      <p class="form-control-static"><s:message code="model.type.${queryType}"/><f:hidden name="type" value="node_home"/></p>
	            </div>
	          </div>
	        </div>
	      </div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
	            <label class="col-sm-2 control-label"><em class="required">*</em><s:message code="model.template"/></label>
	            <div class="col-sm-10">
	            	<div class="input-group">
						      <f:text id="customs_template" name="customs_template" value="${bean.customs['template']}" class="form-control required" maxlength="255"/>
						      <span class="input-group-btn">
						      	<button class="btn btn-default" id="customs_templateButton" type="button"><s:message code='choose'/></button>
						      </span>
					      </div>
						    <script type="text/javascript">
						    $(function(){
	            ...
	            <div class="col-sm-10 form-inline">
					      <select class="form-control" name="customs_generateNode">
						  	...
						  	<div class="input-group">
						    	...
						    	<f:text class="form-control" name="customs_nodePath" value="${bean.customs['nodePath']}" default="/index" style="text-align:right;width:300px;"/>
						    </div>
	            ...
	            <div class="col-sm-8">
					      <select class="form-control" name="customs_staticMethod" class="required">
