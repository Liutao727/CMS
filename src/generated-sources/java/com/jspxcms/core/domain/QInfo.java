...
public class QInfo extends EntityPathBase<Info> {
    ...
    public final SetPath<InfoBuffer, QInfoBuffer> buffers = this.<InfoBuffer, QInfoBuffer>createSet("buffers", InfoBuffer.class, QInfoBuffer.class, PathInits.DIRECT2);
    ...
    public final ListPath<InfoFile, QInfoFile> files = this.<InfoFile, QInfoFile>createList("files", InfoFile.class, QInfoFile.class, PathInits.DIRECT2);

    public final StringPath htmlStatus = createString("htmlStatus");

    public final NumberPath<Integer> id = createNumber("id", Integer.class);

    public final ListPath<InfoImage, QInfoImage> images = this.<InfoImage, QInfoImage>createList("images", InfoImage.class, QInfoImage.class, PathInits.DIRECT2);

    public final ListPath<InfoAttribute, QInfoAttribute> infoAttrs = this.<InfoAttribute, QInfoAttribute>createList("infoAttrs", InfoAttribute.class, QInfoAttribute.class, PathInits.DIRECT2);

    public final SetPath<InfoMemberGroup, QInfoMemberGroup> infoGroups = this.<InfoMemberGroup, QInfoMemberGroup>createSet("infoGroups", InfoMemberGroup.class, QInfoMemberGroup.class, PathInits.DIRECT2);

    public final ListPath<InfoNode, QInfoNode> infoNodes = this.<InfoNode, QInfoNode>createList("infoNodes", InfoNode.class, QInfoNode.class, PathInits.DIRECT2);

    public final SetPath<InfoOrg, QInfoOrg> infoOrgs = this.<InfoOrg, QInfoOrg>createSet("infoOrgs", InfoOrg.class, QInfoOrg.class, PathInits.DIRECT2);

    public final ListPath<InfoSpecial, QInfoSpecial> infoSpecials = this.<InfoSpecial, QInfoSpecial>createList("infoSpecials", InfoSpecial.class, QInfoSpecial.class, PathInits.DIRECT2);

    public final ListPath<InfoTag, QInfoTag> infoTags = this.<InfoTag, QInfoTag>createList("infoTags", InfoTag.class, QInfoTag.class, PathInits.DIRECT2);
    ...
    public final SetPath<InfoProcess, QInfoProcess> processes = this.<InfoProcess, QInfoProcess>createSet("processes", InfoProcess.class, QInfoProcess.class, PathInits.DIRECT2);
