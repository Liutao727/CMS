...
public class QModel extends EntityPathBase<Model> {
    ...
    public final ListPath<ModelField, QModelField> fields = this.<ModelField, QModelField>createList("fields", ModelField.class, QModelField.class, PathInits.DIRECT2);
