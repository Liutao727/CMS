...
public class QAttachment extends EntityPathBase<Attachment> {
    ...
    public final SetPath<AttachmentRef, QAttachmentRef> refs = this.<AttachmentRef, QAttachmentRef>createSet("refs", AttachmentRef.class, QAttachmentRef.class, PathInits.DIRECT2);
