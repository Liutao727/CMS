...
public class QSpecial extends EntityPathBase<Special> {
    ...
    public final ListPath<SpecialFile, QSpecialFile> files = this.<SpecialFile, QSpecialFile>createList("files", SpecialFile.class, QSpecialFile.class, PathInits.DIRECT2);

    public final NumberPath<Integer> id = createNumber("id", Integer.class);

    public final ListPath<SpecialImage, QSpecialImage> images = this.<SpecialImage, QSpecialImage>createList("images", SpecialImage.class, QSpecialImage.class, PathInits.DIRECT2);
