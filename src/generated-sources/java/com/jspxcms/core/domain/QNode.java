...
public class QNode extends EntityPathBase<Node> {
    ...
    public final SetPath<NodeBuffer, QNodeBuffer> buffers = this.<NodeBuffer, QNodeBuffer>createSet("buffers", NodeBuffer.class, QNodeBuffer.class, PathInits.DIRECT2);
    ...
    public final SetPath<NodeDetail, QNodeDetail> details = this.<NodeDetail, QNodeDetail>createSet("details", NodeDetail.class, QNodeDetail.class, PathInits.DIRECT2);
    ...
    public final SetPath<NodeOrg, QNodeOrg> nodeOrgs = this.<NodeOrg, QNodeOrg>createSet("nodeOrgs", NodeOrg.class, QNodeOrg.class, PathInits.DIRECT2);

    public final SetPath<NodeRole, QNodeRole> nodeRoles = this.<NodeRole, QNodeRole>createSet("nodeRoles", NodeRole.class, QNodeRole.class, PathInits.DIRECT2);
