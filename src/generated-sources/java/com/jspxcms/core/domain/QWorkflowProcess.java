...
public class QWorkflowProcess extends EntityPathBase<WorkflowProcess> {
    ...
    public final SetPath<WorkflowLog, QWorkflowLog> logs = this.<WorkflowLog, QWorkflowLog>createSet("logs", WorkflowLog.class, QWorkflowLog.class, PathInits.DIRECT2);
