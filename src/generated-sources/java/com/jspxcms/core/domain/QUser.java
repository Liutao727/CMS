...
public class QUser extends EntityPathBase<User> {
    ...
    public final SetPath<UserDetail, QUserDetail> details = this.<UserDetail, QUserDetail>createSet("details", UserDetail.class, QUserDetail.class, PathInits.DIRECT2);
    ...
    public final ListPath<UserMemberGroup, QUserMemberGroup> userGroups = this.<UserMemberGroup, QUserMemberGroup>createList("userGroups", UserMemberGroup.class, QUserMemberGroup.class, PathInits.DIRECT2);

    public final StringPath username = createString("username");

    public final ListPath<UserOrg, QUserOrg> userOrgs = this.<UserOrg, QUserOrg>createList("userOrgs", UserOrg.class, QUserOrg.class, PathInits.DIRECT2);
