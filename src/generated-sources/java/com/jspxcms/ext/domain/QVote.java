...
public class QVote extends EntityPathBase<Vote> {
    ...
    public final ListPath<VoteOption, QVoteOption> options = this.<VoteOption, QVoteOption>createList("options", VoteOption.class, QVoteOption.class, PathInits.DIRECT2);
