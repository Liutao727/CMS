...
public class QGuestbook extends EntityPathBase<Guestbook> {
    ...
    public final com.jspxcms.core.domain.QUser creator;
    ...
    public QGuestbook(Class<? extends Guestbook> type, PathMetadata metadata, PathInits inits) {
        ...
        this.creator = inits.isInitialized("creator") ? new com.jspxcms.core.domain.QUser(forProperty("creator"), inits.get("creator")) : null;
        this.replyer = inits.isInitialized("replyer") ? new com.jspxcms.core.domain.QUser(forProperty("replyer"), inits.get("replyer")) : null;
        this.site = inits.isInitialized("site") ? new com.jspxcms.core.domain.QSite(forProperty("site"), inits.get("site")) : null;
