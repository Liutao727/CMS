...
public class QQuestion extends EntityPathBase<Question> {
    ...
    public final SetPath<QuestionRecord, QQuestionRecord> records = this.<QuestionRecord, QQuestionRecord>createSet("records", QuestionRecord.class, QQuestionRecord.class, PathInits.DIRECT2);
