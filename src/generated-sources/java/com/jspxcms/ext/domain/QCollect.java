...
public class QCollect extends EntityPathBase<Collect> {
    ...
    public final ListPath<CollectField, QCollectField> fields = this.<CollectField, QCollectField>createList("fields", CollectField.class, QCollectField.class, PathInits.DIRECT2);
    ...
    public final com.jspxcms.core.domain.QNode node;
    ...
    public QCollect(Class<? extends Collect> type, PathMetadata metadata, PathInits inits) {
        ...
        this.node = inits.isInitialized("node") ? new com.jspxcms.core.domain.QNode(forProperty("node"), inits.get("node")) : null;
