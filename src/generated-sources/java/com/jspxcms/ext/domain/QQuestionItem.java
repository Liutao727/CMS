...
public class QQuestionItem extends EntityPathBase<QuestionItem> {
    ...
    public final ListPath<QuestionOption, QQuestionOption> options = this.<QuestionOption, QQuestionOption>createList("options", QuestionOption.class, QQuestionOption.class, PathInits.DIRECT2);
